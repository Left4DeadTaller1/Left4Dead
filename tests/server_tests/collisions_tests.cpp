...
TEST(CollisionDetectorTest, IsColliding) {
    ...
    Player e1(10, 20, "e1", SMG, "amund");
    Player e2(15, 25, "e2", SMG, "amund");  // Overlapping with e1
    Player e3(50, 60, "e3", SMG, "amund");  // Not overlapping with e1
...
TEST(CollisionDetectorTest, CheckForCollisionsInCrossConfiguration) {
    ...
    Player centerEntity(100, 100, "PlayerCenter", SMG, "amund");  // Entity in the center
    Player rightEntity(125, 100, "PlayerRight", SMG, "amund");    // Entity to the right (at 25 units)
    Player leftEntity(65, 100, "PlayerLeft", SMG, "amund");       // Entity to the left (at 35 units)
    Player topEntity(100, 135, "PlayerTop", SMG, "amund");        // Entity above (at 35 units)
    Player bottomEntity(100, 70, "PlayerBottom", SMG, "amund");   // Entity below (at 30 units)
...
TEST(CollisionDetectorTest, GetBeingAttackedByMelee) {
    ...
    auto e1 = std::make_shared<Player>(15, 25, "Player1", SMG, "amund");  // Within melee range but in the opposite direction
    auto e2 = std::make_shared<Player>(50, 60, "Player2", SMG, "amund");  // Outside melee range
    auto e3 = std::make_shared<Player>(25, 25, "Player3", SMG, "amund");  // Within melee range and in the correct direction
...
TEST(CollisionDetectorTest, GetBeingAttackedBySpear) {
    ...
    Attack spear(SPEAR_ATTACK, 10, 20, RIGHT, 10, 30, entityParams["SPEAR_ATTACK_RANGE"]);  // Spear attack to the right

    auto player1 = std::make_shared<Player>(15, 25, "Player1", SMG, "amund");  // Within spear range but in the opposite direction
    auto player2 = std::make_shared<Player>(50, 60, "Player2", SMG, "amund");  // Outside spear range
    auto player3 = std::make_shared<Player>(25, 25, "Player3", SMG, "amund");  // Within spear range and in the correct direction
...
TEST(CollisionDetectorTest, GetBeingAttackedByShortVenom) {
    ...
    auto player1 = std::make_shared<Player>(15, 25, "Player1", SMG, "amund");  // Within short venom range but in the opposite direction
    auto player2 = std::make_shared<Player>(50, 60, "Player2", SMG, "amund");  // Outside short venom range
    auto player3 = std::make_shared<Player>(25, 25, "Player3", SMG, "amund");  // Within short venom range and in the correct direction
...
TEST(CollisionDetectorTest, GetBeingAttackedByLongVenom) {
    ...
    auto player1 = std::make_shared<Player>(15, 35, "Player1", SMG, "amund");  // Within long venom range but in the opposite direction
    auto player2 = std::make_shared<Player>(60, 70, "Player2", SMG, "amund");  // Outside long venom range
    auto player3 = std::make_shared<Player>(45, 20, "Player3", SMG, "amund");  // Within long venom range and in the correct direction
